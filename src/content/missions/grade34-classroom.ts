...
export const GRADE34_CLASSROOM_MISSIONS = [
  {
    ...
    gradeBand: '3-4',
    titleKo: '어느 상자',
    scenarioKo: '교실에 빨간 상자와 파란 상자가 함께 있습니다.',
    politenessContext: 'classroom-polite',
    curriculumCodes: ['[4영02-10]'],
    learningTargets: ['understand', 'apply', 'analyze', 'create'],
    dialogue: [
      { id: 'g34-classroom-box-dialogue', speaker: 'Teacher', textEn: 'Please put the crayons in that box.' },
    ],
    ambiguityOptions: [
      ...
      { id: 'g34-classroom-box--ambiguity-distractor-a', turnId: 'g34-classroom-box-dialogue', labelEn: 'the crayons', slotKind: 'object', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
      { id: 'g34-classroom-box--ambiguity-distractor-b', turnId: 'g34-classroom-box-dialogue', labelEn: 'Please put', slotKind: 'object', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
    ],
    ...
    meaningOptions: [
      ...
      { id: 'g34-classroom-box--meaning-retry-a', labelKo: '문 옆 빨간 상자', accepted: false, feedbackKo: createMeaningRetryFeedback('object') },
      { id: 'g34-classroom-box--meaning-retry-b', labelKo: '책상 아래 파란 상자', accepted: false, feedbackKo: createMeaningRetryFeedback('object') },
    ],
    confirmationOptions: [
  ...
  },
  {
    ...
    gradeBand: '3-4',
    titleKo: '어떤 연필',
    scenarioKo: '책상에 긴 연필과 짧은 연필이 있습니다.',
    politenessContext: 'classroom-polite',
    curriculumCodes: ['[4영02-10]'],
    learningTargets: ['understand', 'apply', 'analyze', 'create'],
    dialogue: [
      { id: 'g34-classroom-pencil-dialogue', speaker: 'Partner', textEn: 'Can you pass me that one?' },
    ],
    ambiguityOptions: [
      ...
      { id: 'g34-classroom-pencil--ambiguity-distractor-a', turnId: 'g34-classroom-pencil-dialogue', labelEn: 'pass me', slotKind: 'object', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
      { id: 'g34-classroom-pencil--ambiguity-distractor-b', turnId: 'g34-classroom-pencil-dialogue', labelEn: 'Can you', slotKind: 'object', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
    ],
    allowedStrategyIds: ['specify', 'confirm'],
    repairOptions: [
    ...
    meaningOptions: [
      ...
      { id: 'g34-classroom-pencil--meaning-retry-a', labelKo: '긴 연필', accepted: false, feedbackKo: createMeaningRetryFeedback('object') },
      { id: 'g34-classroom-pencil--meaning-retry-b', labelKo: '짧은 자', accepted: false, feedbackKo: createMeaningRetryFeedback('object') },
    ],
    confirmationOptions: [
