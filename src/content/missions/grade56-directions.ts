...
export const GRADE56_DIRECTIONS_MISSIONS = [
  {
    id: 'g56-directions-place',
    gradeBand: '5-6',
    titleKo: '비슷한 장소 이름',
    scenarioKo: '길 안내에 체육관과 음악당이 함께 나옵니다.',
    politenessContext: 'peer-brief',
    curriculumCodes: ['[6영02-07]', '[6영02-09]'],
    learningTargets: ['understand', 'apply', 'analyze', 'create'],
    dialogue: [
      { id: 'g56-directions-place-dialogue', speaker: 'Guide', textEn: 'After the bank, turn toward the hall.' },
    ],
    ambiguityOptions: [
      ...
      { id: 'g56-directions-place--ambiguity-distractor-a', turnId: 'g56-directions-place-dialogue', labelEn: 'the bank', slotKind: 'place', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
      { id: 'g56-directions-place--ambiguity-distractor-b', turnId: 'g56-directions-place-dialogue', labelEn: 'After', slotKind: 'place', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
    ],
    ...
    meaningOptions: [
      ...
      { id: 'g56-directions-place--meaning-retry-a', labelKo: '빵집 맞은편 체육관', accepted: false, feedbackKo: createMeaningRetryFeedback('place') },
      { id: 'g56-directions-place--meaning-retry-b', labelKo: '은행 옆 음악당', accepted: false, feedbackKo: createMeaningRetryFeedback('place') },
    ],
    confirmationOptions: [
  ...
  },
  {
    ...
    gradeBand: '5-6',
    titleKo: '길 안내 순서',
    scenarioKo: '약국과 두 번째 신호등 뒤의 이동 순서를 확인합니다.',
    politenessContext: 'peer-brief',
    curriculumCodes: ['[6영02-07]', '[6영02-09]'],
    learningTargets: ['understand', 'apply', 'analyze', 'create'],
    dialogue: [
      { id: 'g56-directions-sequence-dialogue', speaker: 'Guide', textEn: 'Walk past the pharmacy and cross at the second light. Then take the next turn.' },
    ],
    ambiguityOptions: [
      ...
      { id: 'g56-directions-sequence--ambiguity-distractor-a', turnId: 'g56-directions-sequence-dialogue', labelEn: 'the pharmacy', slotKind: 'sequence', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
      { id: 'g56-directions-sequence--ambiguity-distractor-b', turnId: 'g56-directions-sequence-dialogue', labelEn: 'the second light', slotKind: 'sequence', accepted: false, feedbackKo: AMBIGUITY_RETRY_FEEDBACK_KO },
    ],
    allowedStrategyIds: ['specify', 'confirm'],
    repairOptions: [
    ...
    meaningOptions: [
      ...
      { id: 'g56-directions-sequence--meaning-retry-a', labelKo: '두 번째 신호등 뒤 좌회전', accepted: false, feedbackKo: createMeaningRetryFeedback('sequence') },
      { id: 'g56-directions-sequence--meaning-retry-b', labelKo: '우회전 뒤 왼쪽 두 번째 건물 도서관', accepted: false, feedbackKo: createMeaningRetryFeedback('sequence') },
    ],
    confirmationOptions: [
