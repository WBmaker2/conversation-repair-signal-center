...
export const GRADE34_RECESS_CONTRACT = [
  {
    id: 'g34-recess-place', gradeBand: '3-4', titleKo: '약속 장소', scenarioKo: '놀이터에 그네, 운동장 문, 벤치가 보입니다.', politenessContext: 'peer-brief', curriculumCodes: ['[4영02-10]'], learningTargets: ['understand', 'apply', 'analyze', 'create'],
    ...
    ambiguityOptions: [
      ...
      { id: 'g34-recess-place--ambiguity-distractor-a', turnId: 'g34-recess-place-dialogue', labelEn: 'after lunch', slotKind: 'place', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 대화에서 두 가지로 해석되거나 놓친 부분을 다시 찾아보세요.' },
      { id: 'g34-recess-place--ambiguity-distractor-b', turnId: 'g34-recess-place-dialogue', labelEn: 'Let’s meet', slotKind: 'place', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 대화에서 두 가지로 해석되거나 놓친 부분을 다시 찾아보세요.' },
    ],
    ...
    meaningOptions: [
      ...
      { id: 'g34-recess-place--meaning-retry-a', labelKo: '그네 옆', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 장소 정보를 다시 찾아보세요.' },
      { id: 'g34-recess-place--meaning-retry-b', labelKo: '교실 문 앞', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 장소 정보를 다시 찾아보세요.' },
    ],
    confirmationOptions: [
  ...
  {
    id: 'g34-recess-time', gradeBand: '3-4', titleKo: '놀이 시작 시간', scenarioKo: '종이 울려 친구의 말을 잘 듣지 못했습니다.', politenessContext: 'peer-brief', curriculumCodes: ['[4영02-10]'], learningTargets: ['understand', 'apply', 'analyze', 'create'],
    ...
    ambiguityOptions: [
      ...
      { id: 'g34-recess-time--ambiguity-distractor-a', turnId: 'g34-recess-time-dialogue', labelEn: 'the bell sound', slotKind: 'whole-utterance', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 대화에서 두 가지로 해석되거나 놓친 부분을 다시 찾아보세요.' },
      { id: 'g34-recess-time--ambiguity-distractor-b', turnId: 'g34-recess-time-dialogue', labelEn: 'the speaker', slotKind: 'whole-utterance', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 대화에서 두 가지로 해석되거나 놓친 부분을 다시 찾아보세요.' },
    ],
    ...
    meaningOptions: [
      ...
      { id: 'g34-recess-time--meaning-retry-a', labelKo: '오후 1시', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 문장 전체 정보를 다시 찾아보세요.' },
      { id: 'g34-recess-time--meaning-retry-b', labelKo: '오후 2시 30분', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 문장 전체 정보를 다시 찾아보세요.' },
    ],
    confirmationOptions: [
  ...
  {
    id: 'g34-recess-rephrase', gradeBand: '3-4', titleKo: '장소를 다시 설명하기', scenarioKo: '친구가 내가 말한 장소를 이해하지 못했습니다.', politenessContext: 'peer-brief', curriculumCodes: ['[4영02-10]'], learningTargets: ['understand', 'apply', 'analyze', 'create'],
    dialogue: [
    ...
    meaningOptions: [
      ...
      { id: 'g34-recess-rephrase--meaning-retry-a', labelKo: '큰 나무 아래', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 장소 정보를 다시 찾아보세요.' },
      { id: 'g34-recess-rephrase--meaning-retry-b', labelKo: '그네 옆', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 장소 정보를 다시 찾아보세요.' },
    ],
    confirmationOptions: [
