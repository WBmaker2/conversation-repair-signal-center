...
export const GRADE56_EVENTS_CONTRACT = [
  {
    id: 'g56-event-decision', gradeBand: '5-6', titleKo: '행사 최종 계획', scenarioKo: '두 시간·장소 제안 가운데 확정된 계획을 확인합니다.', politenessContext: 'peer-brief', curriculumCodes: ['[6영02-07]', '[6영02-09]', '[6영02-10]'], learningTargets: ['understand', 'apply', 'analyze', 'create'],
    ...
    ambiguityOptions: [
      ...
      { id: 'g56-event-decision--ambiguity-distractor-a', turnId: 'g56-event-decision-dialogue', labelEn: 'the library', slotKind: 'decision', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 대화에서 두 가지로 해석되거나 놓친 부분을 다시 찾아보세요.' },
      { id: 'g56-event-decision--ambiguity-distractor-b', turnId: 'g56-event-decision-dialogue', labelEn: 'the art room', slotKind: 'decision', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 대화에서 두 가지로 해석되거나 놓친 부분을 다시 찾아보세요.' },
    ],
    ...
    meaningOptions: [
      ...
      { id: 'g56-event-decision--meaning-retry-a', labelKo: '오후 2시 도서관이 최종 계획', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 최종 결정 정보를 다시 찾아보세요.' },
      { id: 'g56-event-decision--meaning-retry-b', labelKo: '오후 3시 도서관이 최종 계획', accepted: false, feedbackKo: '어떤 정보가 아직 없나요? 상대의 추가 답에서 새로 확인된 최종 결정 정보를 다시 찾아보세요.' },
    ],
    confirmationOptions: [
